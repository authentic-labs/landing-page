      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">Trusted by over 20,000 investitors in all the world</h2>
            {/* <p className="text-xl text-gray-600" data-aos="zoom-y-out">Nos somos uma empresa P&D blockchain.</p> */}
          </div>
          ...
          <div className="max-w-3xl mx-auto mt-20" data-aos="zoom-y-out">
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              "Estamos vivendo um momento único. Saber que estamos fazendo parte de uma virada na história humana é motivo de alegria e satisfação para todo nosso time, estamos focados em criar."
                </blockquote> */}
                <cite className="block font-bold text-lg not-italic mb-1">Vitalik</cite>
                <div className="text-gray-600">
                  <span>CEO & Founder</span> <a className="text-blue-600 hover:underline" href="#0">@AuthenticLabs</a>
                </div>
              </div>
          ...
          <div className="max-w-3xl mx-auto mt-20" data-aos="zoom-y-out">
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                ...
                {/* <blockquote className="text-xl font-medium mb-4">
               e satisfação para todo nosso time, estamos focados em criar."
                </blockquote> */}
                <cite className="block font-bold text-lg not-italic mb-1">Vitalik</cite>
                <div className="text-gray-600">
                  <span>CEO & Founder</span> <a className="text-blue-600 hover:underline" href="#0">@AuthenticLabs</a>
